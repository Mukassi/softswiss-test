export const CartIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 20" className="cart-icon">
      <defs>
        <linearGradient id="cartGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="15%" style={{ stopColor: '#ebff00', stopOpacity: 1 }} />
          <stop offset="80%" style={{ stopColor: '#ff70d9', stopOpacity: 1 }} />
        </linearGradient>
      </defs>
      <path
        fill="currentColor"
